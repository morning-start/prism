...
> Authoritative type definitions: `src/lux/lux.mbt`, `src/lux/lux_builders.mbt`, `src/lux/lux_helpers.mbt`
...
- Type definitions: `src/lux/lux.mbt` (types), `src/lux/lux_builders.mbt` (constructors)
- JSON Schema: `schemas/lux-ir-v1.json`
